...
class adLDAP {
     ...
     * @var string
     */
    //protected $accountSuffix = "@ldapunica.cu";
    protected $accountSuffix = "@unica.cu";
     ...
     * @var string
     */
    //protected $baseDn = "DC=ldapunica,DC=cu";
    protected $baseDn = "DC=unica,DC=cu"; 
     ...
     * @var array
     */
    protected $domainControllers = array("10.18.1.12");
    //protected $domainControllers = array("10.18.1.2");
     ...
     * @var string
     */
    protected $adminUsername = "yoedusvanyh";
    protected $adminPassword = "Admin123";
